...
macrobio5 <- rast("/lustre1/scratch/348/vsc34871/output/1981-2010chelsaBIO5_EUforests_25m.tif")
macrobio6 <- rast("/lustre1/scratch/348/vsc34871/output/1981-2010chelsaBIO6_EUforests_25m.tif")
macrobio5
macrobio6
plot(macrobio5)
...
writeRaster(offsetbio5,
    filename = "/lustre1/scratch/348/vsc34871/output/OffsetBIO5_Current.tif",
    overwrite = TRUE
)
...
writeRaster(offsetbio6,
    filename = "/lustre1/scratch/348/vsc34871/output/OffsetBIO6_Current.tif",
    overwrite = TRUE
)